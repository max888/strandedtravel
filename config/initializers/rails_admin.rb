# RailsAdmin config file. Generated on March 16, 2014 10:55
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Stranded Travel', 'Admin']
  ...
  # config.excluded_models = ['Activity', 'Category', 'Destination']

  # Include specific models (exclude the others):
  # config.included_models = ['Activity', 'Category', 'Destination']
  ...
  #     configure :destination_id, :integer         # Hidden 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your destination.rb model definition
